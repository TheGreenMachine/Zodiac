...
public class PathBuilder {
    ...
    public static class Waypoint {
        ...
        /**
         * @param x position into field in inches 0 is DS wall
         * @param y left or right in inches 0 is center of DS wall
         * @param r radius of arc in inches
         * @param s speed in in/sec
         */
