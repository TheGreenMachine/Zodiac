...
public class DistanceManager {
    ...
    private final Entry[] buckets = new Entry[] {
        ...
        new Entry(167, 11_100, 2, 0),/* 167, 198 were 1.5 */
        new Entry(198, 10_400, 1, 0),
        new Entry(210, 8_600, 1, -1.5),
        new Entry(250, 8_500, 1, -1.5/*1.5*/),
        new Entry(285, 9_000, 1, 0.5),
        // new Entry(315, 10_100, 1, 1.875),
        new Entry(360, 9_000, 1, 1.75),
