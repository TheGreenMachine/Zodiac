...
public class PhysicsSim {
    private static PhysicsSim INSTANCE;

    public static PhysicsSim getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new PhysicsSim();
        }
        return INSTANCE;
    }
     ...
     */
    public void addTalonSRX(IMotorControllerEnhanced talon, final double accelToFullTime, final double fullVel) {
     ...
     */
    public void addTalonSRX(IMotorControllerEnhanced talon, final double accelToFullTime, final double fullVel, final boolean sensorPhase) {
        if (talon != null) {
