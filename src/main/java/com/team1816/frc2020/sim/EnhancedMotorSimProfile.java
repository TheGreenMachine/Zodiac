package com.team1816.frc2020.sim;

import com.ctre.phoenix.motorcontrol.IMotorControllerEnhanced;
import com.ctre.phoenix.motorcontrol.can.TalonFX;
import com.ctre.phoenix.motorcontrol.can.TalonSRX;

import static com.team1816.frc2020.sim.PhysicsSim.random;

public class EnhancedMotorSimProfile extends PhysicsSim.SimProfile {
    private final IMotorControllerEnhanced _talon;
     ...
     */
    public EnhancedMotorSimProfile(final IMotorControllerEnhanced talon, final double accelToFullTime, final double fullVel, final boolean sensorPhase) {
        this._talon = talon;
